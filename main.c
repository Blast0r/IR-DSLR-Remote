/* 
Changed by Blast0r in November 2014, Licensed under CC BY-NC-SA 2.5
  * Added LED on during transmission.
  
*/

/*
	Based on: 
	Timelapse Remote control by andyk75 found at indstructables, http://www.instructables.com/id/Camera-remote-control-and-timelapse/
	...
	2 PB 4 , pushbutton to GND, internal pullup active (0 = pressed, 1 = open) Startbutton
	3 PB 3 , pushbutton to GND, internal pullup active , timelapse adjust
	4 GND
...
#define LED_OFF()		PORTB &= ~(1<<irleds) //original, auf FET ausgelegt!
...
int main(){
	...
	//PORTB &= ~(1<<irleds); //irleds Ausschalten!! Die Brennen sonst schnell durch 
